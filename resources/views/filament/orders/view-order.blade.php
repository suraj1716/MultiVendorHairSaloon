<x-filament::page class="text-gray-800 print:bg-white print:text-black">
    ...
    <div class="flex justify-end mb-6 print:hidden">
        <button onclick="window.print()"
            class="bg-blue-600 text-white px-5 py-2 rounded shadow hover:bg-blue-700 text-sm">
            Print Invoice
        </button>
    </div>
    ...
    <div id="invoice-print-area"
        class="bg-white p-6 shadow rounded h-100 border print:shadow-none print:border-none print:p-6 print:m-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-sm text-gray-800 print-three-cols">
                ...
                <div>
                    ...
                    @if ($record->shippingAddress)
                        ...
                        <p class="mb-1">{{ $record->shippingAddress->city }}, {{ $record->shippingAddress->state }}
                            {{ $record->shippingAddress->postal_code }}</p>
    ...
    <table class="w-full table-auto text-sm border-collapse min-w-[700px]">
        <thead class="bg-gray-100">
            <tr>
                ...
                <th class="p-3 border">Designer</th> {{-- ✅ NEW --}}
