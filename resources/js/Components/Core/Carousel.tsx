...
export default function Carousel({ images, index, onIndexChange }: CarouselProps) {
 return (
  <div className="flex flex-col lg:flex-row lg:items-start gap-4">
      ...
      <div className="flex flex-row items-start gap-2 lg:flex-col">
        {images.map((image, i) => (
          <button
            ...
            className={`aspect-square h-16 sm:h-20 overflow-hidden rounded-lg border-2 transition-all ${
    ...
    {/* Main Image */}
    <div className="lg:order-2 lg:ml-5 max-w-full lg:max-w-xl overflow-hidden rounded-lg relative w-full aspect-[5/4] sm:aspect-[5/4]">
      <img
